...
function resetAppearance(){Object.assign(state,{accentColor:'#ffffff',nameColor:'#ffffff',numberColor:'#ffffff',bgOpacity:88,showBorder:true,textOutline:true,hudScale:100,hudY:78,outlineSize:2,shadowSize:4});render();save()}
function defaults(){
 const d={championship:'DBD CHAMPIONSHIP',overlayStyle:1,accentColor:'#ffffff',nameColor:'#ffffff',numberColor:'#ffffff',bgOpacity:88,showBorder:true,textOutline:true,showRoles:true,showRoleLabels:true,killerSide:'A',showSet:true,hudScale:100,hudY:78,outlineSize:2,shadowSize:4,nameAX:0,nameAY:0,nameBX:0,nameBY:0,roleAX:0,roleAY:0,roleBX:0,roleBY:0,statsAX:0,statsAY:0,statsBX:0,statsBY:0};
